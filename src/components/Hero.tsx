          ...
          <div className="md:px-12 px-6 mx-auto max-w-7xl">
              <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
                  ...
                  <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
                      <a href="#_" className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-black bg-gradient-to-r from-yellow-600 to-green-400  rounded-2xl sm:w-auto sm:mb-0">
                          Get Started
              ...
              <div className="w-full  mx-auto mt-20 text-center md:w-10/12">
                  <div className="relative z-0 w-full mt-8">
                      <div className="relative overflow-hidden h-[50vh] shadow-2xl">
                          <div className="flex items-center flex-none px-4 bg-yellow-600 rounded-b-none h-11 rounded-xl">
                          ...
                          <img className="h-full object-cover w-full" src={heros} />
                      </div>
                  </div>
              </div>
          </div>
